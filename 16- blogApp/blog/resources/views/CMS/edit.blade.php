...
<body>
<form action="{{route('author.posts.update',[$authorId,$post->id])}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="container">
        ...
        <div name='postContentEdited' id="content" contenteditable="true" spellcheck="false">
            <h1>{{$post->title}}</h1>
            {!! $post->content !!}
        </div>
